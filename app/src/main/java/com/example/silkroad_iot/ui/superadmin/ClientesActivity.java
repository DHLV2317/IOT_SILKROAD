...
public class ClientesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void cargarLista() {
        ...
        clienteList = Global.listaClientes;
        ListaClientesAdapter listaClientesAdapter = new ListaClientesAdapter();
        listaClientesAdapter.setListaClientes(clienteList);
        listaClientesAdapter.setContext(ClientesActivity.this);
        binding.recyclerView.setAdapter(listaClientesAdapter);
        binding.recyclerView.setLayoutManager(new LinearLayoutManager(ClientesActivity.this));
