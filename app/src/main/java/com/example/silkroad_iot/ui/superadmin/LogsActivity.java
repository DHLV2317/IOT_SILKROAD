...
public class LogsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public void cargarLista() {
        ...
        logList = Global.listaLogs;
        ListaLogsAdapter listaLogsAdapter = new ListaLogsAdapter();
        listaLogsAdapter.setListaLogs(logList);
        listaLogsAdapter.setContext(LogsActivity.this);
        binding.recyclerView.setAdapter(listaLogsAdapter);
        binding.recyclerView.setLayoutManager(new LinearLayoutManager(LogsActivity.this));
